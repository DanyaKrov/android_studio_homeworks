package com.example.myflappybird.model;
...
public class Pipe extends GameObject {
    ...
    public boolean isPassed(GameObject object){
        if (x < object.x - bottomPipe.getWidth() / 2f - X_SPEED && x > object.x - bottomPipe.getWidth()){
            return true;
        }
        return false;
    }
